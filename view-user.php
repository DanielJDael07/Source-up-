...
// Update status
if (isset($_GET['status'], $_SESSION['account_loggedin']) && ($_SESSION['account_role'] == 'Admin' || $ticket['account_id'] == $_SESSION['account_id']) && in_array($_GET['status'], ['open', 'closed', 'resolved'])) {
...
<div class="content view">
    ...
    <?php if (isset($_SESSION['account_loggedin']) && ($_SESSION['account_role'] == 'Admin' || $ticket['account_id'] == $_SESSION['account_id'])): ?>
    <div class="btns">
